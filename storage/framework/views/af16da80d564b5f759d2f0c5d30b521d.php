        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex space-x-4">
                    <a href="<?php echo e(route('admin.posts.index')); ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 flex items-center space-x-2">
...
function selectFormat(format) {
    ...
    window.location.href = `<?php echo e(route('admin.posts.create')); ?>?type=${format}`;
}
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\posts\add.blade.php ENDPATH**/ ?>