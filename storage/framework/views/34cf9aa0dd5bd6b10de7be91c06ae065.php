...
<td class="px-4 py-3 text-slate-600 dark:text-white text-sm"><?php echo e($post->updated_at->format('M d, Y H:i')); ?></td>
<td class="px-4 py-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\posts\drafts.blade.php ENDPATH**/ ?>