                                ...
                                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-6">
                                    {images.map((image, index) => (
                                        <div
                                            ...
                                            style=<?php echo e(transform: `translateY(${index === 2 ? '-8px' : index % 2 === 0 ? '8px' : '-4px'})`,
...
<?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\components\hero-react.blade.php ENDPATH**/ ?>