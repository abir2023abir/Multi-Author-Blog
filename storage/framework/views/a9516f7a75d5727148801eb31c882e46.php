...
<p class="text-slate-800 dark:text-white tracking-light text-2xl font-bold leading-tight">$<?php echo e(number_format($totalEarnings, 2)); ?></p>
</div>
<div class="rounded-lg border border-slate-200 dark:border-[#324d67] bg-white dark:bg-[#111a22] p-6">
<p class="text-slate-600 dark:text-white text-base font-medium leading-normal">This Month</p>
<p class="text-slate-800 dark:text-white tracking-light text-2xl font-bold leading-tight">$<?php echo e(number_format($thisMonth, 2)); ?></p>
</div>
<div class="rounded-lg border border-slate-200 dark:border-[#324d67] bg-white dark:bg-[#111a22] p-6">
<p class="text-slate-600 dark:text-white text-base font-medium leading-normal">Last Month</p>
<p class="text-slate-800 dark:text-white tracking-light text-2xl font-bold leading-tight">$<?php echo e(number_format($lastMonth, 2)); ?></p>
</div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\earnings\index.blade.php ENDPATH**/ ?>