...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="url" name="video_url" id="video_url" value="<?php echo e(old('video_url')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="url" name="thumbnail_url" id="thumbnail_url" value="<?php echo e(old('thumbnail_url')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="author_name" id="author_name" value="<?php echo e(old('author_name')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="url" name="author_channel" id="author_channel" value="<?php echo e(old('author_channel')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category" id="category"
                            ...
                            <option value="Music" <?php echo e(old('category') == 'Music' ? 'selected' : ''); ?>>Music</option>
                            <option value="Technology" <?php echo e(old('category') == 'Technology' ? 'selected' : ''); ?>>Technology</option>
                            <option value="Education" <?php echo e(old('category') == 'Education' ? 'selected' : ''); ?>>Education</option>
                            <option value="Entertainment" <?php echo e(old('category') == 'Entertainment' ? 'selected' : ''); ?>>Entertainment</option>
                            <option value="News" <?php echo e(old('category') == 'News' ? 'selected' : ''); ?>>News</option>
                            <option value="Sports" <?php echo e(old('category') == 'Sports' ? 'selected' : ''); ?>>Sports</option>
                            <option value="Lifestyle" <?php echo e(old('category') == 'Lifestyle' ? 'selected' : ''); ?>>Lifestyle</option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\videos\create.blade.php ENDPATH**/ ?>