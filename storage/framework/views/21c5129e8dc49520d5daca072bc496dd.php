...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center space-x-2">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900" id="total-users"><?php echo e($users->total()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600" id="active-users"><?php echo e($users->where('status', 'active')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600" id="admin-users"><?php echo e($users->filter(function($user) { return $user->hasRole('admin'); })->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-600" id="new-today"><?php echo e($users->where('created_at', '>=', today())->count()); ?></p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody id="users-table-body" class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50" data-user-id="<?php echo e($user->id); ?>">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" class="user-checkbox rounded border-gray-300" value="<?php echo e($user->id); ?>">
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=random" alt="<?php echo e($user->name); ?>">
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex flex-wrap gap-1">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($role->name === 'admin' ? 'bg-purple-100 text-purple-800' : ($role->name === 'writer' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800')); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <button onclick="toggleUserStatus(<?php echo e($user->id); ?>)" class="text-yellow-600 hover:text-yellow-900">
                                    <span class="material-symbols-outlined text-sm"><?php echo e($user->status === 'active' ? 'pause' : 'play_arrow'); ?></span>
                                </button>
                                <?php if($user->id !== Auth::id()): ?>
                                <button onclick="deleteUser(<?php echo e($user->id); ?>)" class="text-red-600 hover:text-red-900">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\users\index.blade.php ENDPATH**/ ?>