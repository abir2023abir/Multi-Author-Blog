    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="text-xl font-bold text-black" style="color: black !important;">Multi Author Blog Web</a>
                </div>
            </div>

            <!-- Center - Navigation Links -->
            <div class="hidden md:flex items-center space-x-6">
                <a href="<?php echo e(route('home')); ?>" class="px-3 py-2 rounded-lg <?php echo e(request()->routeIs('home') ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-50'); ?> font-medium text-sm flex items-center space-x-1" style="color: <?php echo e(request()->routeIs('home') ? '#2563eb' : 'black'); ?> !important;">
            ...
            <div class="flex items-center space-x-4">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(auth()->user()->hasRole('admin') ? route('admin.dashboard') :
                            (auth()->user()->hasRole('writer') ? route('writer.dashboard') : route('user.dashboard'))); ?>" class="px-4 py-2 text-black hover:bg-gray-50 rounded-lg font-medium text-sm" style="color: black !important;">
                            Dashboard
                        </a>
                ...
                <?php else: ?>
                    <!-- Guest User Menu -->
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 bg-blue-600 text-white font-bold rounded-lg text-sm hover:bg-blue-700 transition-colors" style="background-color: #2563eb !important; color: white !important; font-weight: bold !important;">Login</a>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                <a href="<?php echo e(route('home')); ?>" class="block px-3 py-2 rounded-md text-base font-medium text-black hover:bg-gray-50 flex items-center space-x-2" style="color: black !important;">
                    <span class="material-symbols-outlined text-sm">home</span>
                    <span>Home</span>
                </a>
                ...
                <div class="border-t border-gray-200 pt-4 mt-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(auth()->user()->hasRole('admin') ? route('admin.dashboard') :
                            (auth()->user()->hasRole('writer') ? route('writer.dashboard') : route('user.dashboard'))); ?>" class="block px-3 py-2 rounded-md text-base font-medium text-black hover:bg-gray-50" style="color: black !important;">Dashboard</a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block px-3 py-2 rounded-md text-base font-bold bg-blue-600 text-white hover:bg-blue-700 transition-colors" style="background-color: #2563eb !important; color: white !important; font-weight: bold !important;">Login</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views/components/navigation.blade.php ENDPATH**/ ?>