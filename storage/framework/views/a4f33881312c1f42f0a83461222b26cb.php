    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('writer.posts.update', $post)); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div>
                        <label class="block text-sm font-medium">Title</label>
                        <input name="title" value="<?php echo e(old('title', $post->title)); ?>" class="mt-1 w-full rounded border-gray-300 dark:bg-gray-900" required />
                    ...
                    <div>
                        ...
                        <select name="category_id" class="mt-1 w-full rounded border-gray-300 dark:bg-gray-900">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>" <?php if(old('category_id', $post->category_id) == $c->id): echo 'selected'; endif; ?>><?php echo e($c->name); ?></option>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="10" class="mt-1 w-full rounded border-gray-300 dark:bg-gray-900" required><?php echo e(old('content', $post->content)); ?></textarea>
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\writer\posts\edit.blade.php ENDPATH**/ ?>