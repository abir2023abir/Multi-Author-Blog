        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="text-gray-600">Create a new <?php echo e(ucfirst($type)); ?> post</p>
                </div>
                <div class="flex space-x-4">
                    <a href="<?php echo e(route('admin.posts.add')); ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 flex items-center space-x-2">
                        <span class="material-symbols-outlined text-sm">arrow_back</span>
                        <span>Back to Formats</span>
                    </a>
                    <a href="<?php echo e(route('admin.posts.index')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2">
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Short description"><?php echo e(old('excerpt')); ?></textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <div id="editor-container" class="border border-gray-300 rounded-lg">
                                ...
                                <div id="editor-content"
                                     ...
                                     style="min-height: 300px;"><?php echo e(old('content')); ?></div>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\posts\create.blade.php ENDPATH**/ ?>