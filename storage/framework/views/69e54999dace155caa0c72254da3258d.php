...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex space-x-4">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow">
            <form action="<?php echo e(route('user.posts.store')); ?>" method="POST" enctype="multipart/form-data" class="p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-4">
                        <div class="space-y-3">
                            ...
                            <!-- Guides -->
                            <label class="flex items-center space-x-3 cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="checkbox" name="categories[]" value="guides" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <span class="text-sm text-gray-700 font-medium">Guides</span>
                            </label>

                            <!-- Destination -->
                            <label class="flex items-center space-x-3 cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="checkbox" name="categories[]" value="destination" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <span class="text-sm text-gray-700 font-medium">Destination</span>
                            </label>
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Brief description of your post (will be auto-generated if left empty)"><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="published" <?php echo e(old('status') == 'published' ? 'selected' : ''); ?>>Publish Immediately</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="<?php echo e(route('user.posts.index')); ?>" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                        Cancel
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\user\posts\create.blade.php ENDPATH**/ ?>