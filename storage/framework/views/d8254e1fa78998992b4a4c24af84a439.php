            ...
            <div class="articles-main">
                ...
                <div class="articles-header">
                    <div class="header-content">
                        <h2 class="articles-title"><?php echo e(setting('articles_section_title', 'Latest articles')); ?></h2>
                        <p class="articles-subtitle"><?php echo e(setting('articles_section_subtitle', 'Explore the most popular categories')); ?></p>
                    </div>
                </div>
...
</script><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\components\latest-articles.blade.php ENDPATH**/ ?>