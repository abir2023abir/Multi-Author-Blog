...
<div>
<p class="text-slate-800 dark:text-white font-medium"><?php echo e($post->title); ?></p>
<p class="text-sm text-slate-500 dark:text-[#92adc9]"><?php echo e($post->published_at->format('Y-m-d')); ?></p>
</div>
<form method="POST" action="<?php echo e(route('admin.google-news.submit')); ?>">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\admin\google-news\index.blade.php ENDPATH**/ ?>