...
<a href="<?php echo e(route('writer.posts.index')); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
...
function selectFormat(format) {
    ...
    window.location.href = `<?php echo e(route('writer.posts.create-with-format')); ?>?format=${format}`;
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Laravel Projects\Multi Author Blog\resources\views\writer\posts\format-selection.blade.php ENDPATH**/ ?>