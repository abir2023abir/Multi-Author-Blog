...
<div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold" id="users-count">{{ $stats['total_users'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold" id="posts-count">{{ $stats['total_posts'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold" id="comments-count">{{ $stats['total_comments'] ?? 0 }}</p>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" id="published-posts">{{ $stats['published_posts'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" id="categories-count">{{ $stats['total_categories'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" id="pending-posts">{{ $stats['pending_posts'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" id="draft-posts">{{ $stats['draft_posts'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Activity Feed -->
    <div class="mb-6">
        @include('components.admin-activity-feed')
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.posts.index') }}" class="text-blue-600 hover:underline text-sm">View All</a>
            </div>
                    ...
                    <tbody id="recent-posts-table">
                        ...
                        <tr class="border-b border-gray-100">
                            <td class="py-3 text-sm">
                                <a href="{{ route('admin.posts.edit', $post->id) }}" class="text-blue-600 hover:underline">{{ Str::limit($post->title, 30) }}</a>
                            </td>
                            <td class="py-3 text-sm text-gray-900">{{ $post->user->name ?? 'Unknown' }}</td>
                            <td class="py-3 text-sm">
                                <span class="px-2 py-1 text-xs rounded-full {{ $post->status === 'published' ? 'bg-green-100 text-green-800' : ($post->status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800') }}">
                                    {{ ucfirst($post->status) }}
                                </span>
                            </td>
                        </tr>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.categories.index') }}" class="text-blue-600 hover:underline text-sm">View All</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                    ...
                    <tbody id="popular-categories-table">
                        ...
                        <tr class="border-b border-gray-100">
                            <td class="py-3 text-sm">
                                <a href="{{ route('admin.categories.edit', $category->id) }}" class="text-blue-600 hover:underline">{{ $category->name }}</a>
                            </td>
                            <td class="py-3 text-sm text-gray-900">{{ $category->posts_count ?? 0 }}</td>
                            <td class="py-3 text-sm">
