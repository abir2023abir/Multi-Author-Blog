...
<!-- Upload Form -->
<form id="uploadForm" method="POST" action="{{ route('admin.posts.bulk.store') }}" enctype="multipart/form-data" class="mt-6">
@csrf
<div class="hidden">
...
<div class="space-y-4">
<a href="{{ route('admin.posts.bulk.categories') }}" class="block w-full bg-slate-100 dark:bg-[#192633] hover:bg-slate-200 dark:hover:bg-[#2a3441] text-slate-700 dark:text-white px-4 py-3 rounded-lg text-sm font-medium text-center transition-colors">
Category Ids list
</a>

<a href="{{ route('admin.posts.bulk.template') }}" class="block w-full bg-slate-100 dark:bg-[#192633] hover:bg-slate-200 dark:hover:bg-[#2a3441] text-slate-700 dark:text-white px-4 py-3 rounded-lg text-sm font-medium text-center transition-colors">
Download CSV Template
</a>

<a href="{{ route('admin.posts.bulk.example') }}" class="block w-full bg-slate-100 dark:bg-[#192633] hover:bg-slate-200 dark:hover:bg-[#2a3441] text-slate-700 dark:text-white px-4 py-3 rounded-lg text-sm font-medium text-center transition-colors">
