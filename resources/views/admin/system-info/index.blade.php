                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm text-gray-900">{{ $systemInfo['database_driver'] }}</dd>
                        </div>
                    </dl>
                </div>
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm text-gray-900">{{ $systemInfo['upload_max_filesize'] }}</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-gray-500">Post Max Size</dt>
                            <dd class="text-sm text-gray-900">{{ $systemInfo['post_max_size'] }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
