    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <form action="{{ route('admin.article-section.reset') }}" method="POST" class="inline">
                    @csrf
                ...
                <a href="{{ route('admin.dashboard') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <form action="{{ route('admin.article-section.update') }}" method="POST">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="section_title" id="section_title" value="{{ $settings['section_title'] }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="section_subtitle" id="section_subtitle" value="{{ $settings['section_subtitle'] }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="articles_per_page" id="articles_per_page" value="{{ $settings['articles_per_page'] }}" min="1" max="20" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            ...
                            <select name="articles_sort_by" id="articles_sort_by" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="published_at" {{ $settings['articles_sort_by'] == 'published_at' ? 'selected' : '' }}>Published Date</option>
                                <option value="created_at" {{ $settings['articles_sort_by'] == 'created_at' ? 'selected' : '' }}>Created Date</option>
                                <option value="view_count" {{ $settings['articles_sort_by'] == 'view_count' ? 'selected' : '' }}>View Count</option>
                                <option value="title" {{ $settings['articles_sort_by'] == 'title' ? 'selected' : '' }}>Title</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="articles_sort_order" id="articles_sort_order" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="desc" {{ $settings['articles_sort_order'] == 'desc' ? 'selected' : '' }}>Descending</option>
                                <option value="asc" {{ $settings['articles_sort_order'] == 'asc' ? 'selected' : '' }}>Ascending</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="show_sidebar" id="show_sidebar" value="1" {{ $settings['show_sidebar'] ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <label for="show_sidebar" class="ml-2 text-sm text-gray-700">Show Sidebar</label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="show_hottest_authors" id="show_hottest_authors" value="1" {{ $settings['show_hottest_authors'] ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <label for="show_hottest_authors" class="ml-2 text-sm text-gray-700">Show Hottest Authors</label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="show_suggested_tags" id="show_suggested_tags" value="1" {{ $settings['show_suggested_tags'] ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <label for="show_suggested_tags" class="ml-2 text-sm text-gray-700">Show Suggested Tags</label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="show_suggested_categories" id="show_suggested_categories" value="1" {{ $settings['show_suggested_categories'] ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <label for="show_suggested_categories" class="ml-2 text-sm text-gray-700">Show Suggested Categories</label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="show_load_more" id="show_load_more" value="1" {{ $settings['show_load_more'] ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="hottest_authors_limit" id="hottest_authors_limit" value="{{ $settings['hottest_authors_limit'] }}" min="1" max="10" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="suggested_tags_limit" class="block text-sm font-medium text-gray-700 mb-2">Suggested Tags Limit</label>
                            <input type="number" name="suggested_tags_limit" id="suggested_tags_limit" value="{{ $settings['suggested_tags_limit'] }}" min="1" max="20" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="suggested_categories_limit" class="block text-sm font-medium text-gray-700 mb-2">Suggested Categories Limit</label>
                            <input type="number" name="suggested_categories_limit" id="suggested_categories_limit" value="{{ $settings['suggested_categories_limit'] }}" min="1" max="10" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex justify-between items-center mb-2">
                            <h4 class="text-lg font-semibold text-gray-900">{{ $settings['section_title'] }}</h4>
                            <span class="text-sm text-gray-500">{{ $settings['articles_per_page'] }} articles per page</span>
                        </div>
                        <p class="text-gray-600 mb-4">{{ $settings['section_subtitle'] }}</p>
                        ...
                        @if($settings['show_sidebar'])
                            <div class="mt-4 p-3 bg-white rounded border">
                                ...
                                <div class="space-y-2 text-sm">
                                    @if($settings['show_hottest_authors'])
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 bg-gray-300 rounded-full"></div>
                                            <span>Hottest Authors ({{ $settings['hottest_authors_limit'] }})</span>
                                        </div>
                                    @endif
                                    @if($settings['show_suggested_tags'])
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 bg-gray-300 rounded"></div>
                                            <span>Suggested Tags ({{ $settings['suggested_tags_limit'] }})</span>
                                        </div>
                                    @endif
                                    @if($settings['show_suggested_categories'])
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 bg-gray-300 rounded"></div>
                                            <span>Suggested Categories ({{ $settings['suggested_categories_limit'] }})</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('admin.dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-6 rounded-lg transition duration-200">
                        Cancel
                    </a>
