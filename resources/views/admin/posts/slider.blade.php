...
<!-- Page Header -->
<div class="flex items-center justify-between mb-6">
<h1 class="text-slate-800 dark:text-white text-3xl font-bold">Slider Posts</h1>
...
@empty
<tr>
<td colspan="7" class="px-4 py-8 text-center text-slate-500 dark:text-[#92adc9]">No slider posts found.</td>
</tr>
@endforelse
</tbody>
</table>
