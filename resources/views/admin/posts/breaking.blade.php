...
<!-- Page Header -->
<div class="flex items-center justify-between mb-6">
<h1 class="text-slate-800 dark:text-white text-3xl font-bold">Breaking News</h1>
...
<div class="w-10 h-10 bg-red-200 dark:bg-red-800 rounded"></div>
<div>
...
@empty
<tr>
<td colspan="7" class="px-4 py-8 text-center text-slate-500 dark:text-[#92adc9]">No breaking news posts found.</td>
</tr>
@endforelse
</tbody>
</table>
