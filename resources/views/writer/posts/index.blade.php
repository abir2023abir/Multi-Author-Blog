        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('writer.dashboard') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 flex items-center space-x-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if($writerPosts->count() > 0)
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">All Posts ({{ $writerPosts->total() }})</h2>
                </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('writer.posts.show', $post) }}" class="text-blue-600 hover:text-blue-800 p-2 rounded-lg hover:bg-blue-50">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('writer.posts.edit', $post) }}" class="text-green-600 hover:text-green-800 p-2 rounded-lg hover:bg-green-50">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('writer.posts.destroy', $post) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this post?')">
                                                @csrf
                                                @method('DELETE')
        ...
        @else
            <div class="bg-white rounded-lg shadow p-12 text-center">
                ...
                <a href="{{ route('writer.posts.create') }}" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 inline-flex items-center space-x-2">
                    <i class="fas fa-plus"></i>
