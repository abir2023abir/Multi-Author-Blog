        ...
        <div class="container">
            <div class="hero-content">
                <div class="text-content">
                    ...
                    <a href="{{ route('posts.index') }}" class="cta-button">Read More</a>
                </div>
    ...
    <div class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @forelse($latestPosts as $post)
                <article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 post-card" data-post-id="{{ $post->id }}">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <div class="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center">
                                    <span class="text-sm font-medium text-gray-700">{{ substr($post->user->name, 0, 1) }}</span>
                                </div>
