...
<div class="flex h-screen">
    ...
    <aside class="w-64 bg-[#111a22] flex flex-col">
        ...
        <nav class="flex-1 p-4 space-y-2 sidebar-nav overflow-y-auto">
            <!-- Dashboard -->
            <a href="{{ route('admin.dashboard') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <!-- Pages -->
            <a href="{{ route('admin.pages.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.pages.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <!-- Blog -->
            <a href="{{ route('admin.posts.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.posts.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
                <span class="material-symbols-outlined text-white text-lg">article</span>
                <span class="text-white text-sm font-medium">Blog</span>
            </a>

            <!-- Add Post -->
            <a href="{{ route('admin.posts.add') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.posts.add*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <div id="galleries-submenu" class="submenu ml-6 space-y-1 hidden">
                <a href="{{ route('admin.galleries.index') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                    <span class="material-symbols-outlined text-white text-sm">photo</span>
                    <span class="text-white text-xs">All Galleries</span>
                </a>
                <a href="{{ route('admin.galleries.create') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
            ...
            <div id="ads-submenu" class="submenu ml-6 space-y-1 hidden">
                <a href="{{ route('admin.ads.index') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                    <span class="material-symbols-outlined text-white text-sm">campaign</span>
                    <span class="text-white text-xs">All Ads</span>
                </a>
                <a href="{{ route('admin.ads.create') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                    <span class="material-symbols-outlined text-white text-sm">add</span>
            ...
            <!-- Announcements -->
            <a href="{{ route('admin.announcements.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                <span class="material-symbols-outlined text-white text-lg">campaign</span>
                <span class="text-white text-sm font-medium">Announcements</span>
            </a>

            <!-- Comments -->
            <a href="{{ route('admin.comments.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.comments.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <!-- Users -->
            <a href="{{ route('admin.users.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.users.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
                <span class="material-symbols-outlined text-white text-lg">group</span>
                <span class="text-white text-sm font-medium">Users</span>
            </a>

            <!-- Categories -->
            <a href="{{ route('admin.categories.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.categories.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <!-- Newsletters -->
            <a href="{{ route('admin.newsletters.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                <span class="material-symbols-outlined text-white text-lg">mail</span>
                <span class="text-white text-sm font-medium">Newsletters</span>
            </a>

            <!-- Media -->
            <a href="{{ route('admin.media.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
            ...
            <div id="appearance-submenu" class="submenu ml-6 space-y-1 hidden">
                <a href="{{ route('admin.themes.index') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
            ...
            <div id="plugins-submenu" class="submenu ml-6 space-y-1 hidden">
                <a href="{{ route('admin.plugins.index') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                    <span class="material-symbols-outlined text-white text-sm">extension</span>
                    <span class="text-white text-xs">All Plugins</span>
                </a>
                <a href="{{ route('admin.plugins.create') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
                    <span class="material-symbols-outlined text-white text-sm">add</span>
            ...
            <div id="tools-submenu" class="submenu ml-6 space-y-1 hidden">
                <a href="{{ route('admin.tools.index') }}" class="submenu-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
            ...
            <!-- Settings -->
            <a href="{{ route('admin.settings.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.settings.*') ? 'bg-[#233648]' : 'hover:bg-[#233648]' }}">
            ...
            <a href="{{ route('admin.platform-admin.index') }}" class="nav-item flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-[#233648]">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <!-- View Website -->
                    <a href="{{ route('home') }}" target="_blank" class="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                    ...
                    <div class="relative">
                        <button onclick="toggleProfileDropdown()" class="flex items-center space-x-3 hover:bg-gray-100 rounded-lg p-2">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=random" alt="Profile" class="w-8 h-8 rounded-full">
                        ...
                        <div id="profileDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 hidden z-50">
                            <div class="py-1">
                                <a href="{{ route('profile.edit') }}" class="flex items-center space-x-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
...
@include('components.admin-realtime')
</body>
</html>
