...
<head>
    ...
    <title>{{ $title ?? 'Multi Author Blog' }}</title>
    ...
    <!-- Trending Topics CSS -->
    <link rel="stylesheet" href="{{ asset('css/trending-topics.css') }}">
    ...
    <footer class="bg-gray-800 text-white py-8 responsive-footer">
        <div class="max-w-7xl mx-auto px-responsive">
            <div class="text-center">
                <p class="text-responsive-sm">&copy; {{ date('Y') }} Multi Author Blog. All rights reserved.</p>
            </div>
        </div>
    </footer>
