    ...
    <div class="footer-container">
        ...
        <div class="footer-links">
            ...
            <div class="footer-column">
                <h4 class="footer-heading">Getting started</h4>
                <ul class="footer-list">
                    <li><a href="#" class="footer-link">Installation</a></li>
                    <li><a href="#" class="footer-link">Release Notes</a></li>
                    <li><a href="#" class="footer-link">Upgrade Guide</a></li>
                    <li><a href="#" class="footer-link">Browser Support</a></li>
                    <li><a href="#" class="footer-link">Editor Support</a></li>
                </ul>
            </div>
            ...
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    <li><a href="#" class="footer-link">Design features</a></li>
            ...
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="#" class="footer-link">Learn design</a></li>
            ...
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="#" class="footer-link">Community Resources</a></li>
                    <li><a href="#" class="footer-link">Contributing</a></li>
                    <li><a href="#" class="footer-link">Concurrent Mode</a></li>
                </ul>
            </div>
        </div>
    </div>
